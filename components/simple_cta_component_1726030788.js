...
-->
<template>
    <section id="cta-component" style="min-height: 390px" class="bg-gray-50 dark:bg-gray-800 flex-1">
            ...
            <div id="cta-content" class="max-w-screen-sm mx-auto text-center">
                ...
                <div id="cta-subtitle-container" class="flex">
                    <p id="cta-subtitle" class="flex-1 mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">
                        Join thousands who have achieved their fitness goals with our personalized health and workout plans
                    </p>
                </div>
